        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              <h5 className="font-semibold text-neutral-800">Avatars</h5>
            ...
            <div className="space-y-3">
              <h5 className="font-semibold text-neutral-800">Progress Bars</h5>
            ...
            <div className="space-y-3">
              <h5 className="font-semibold text-neutral-800">Skeleton Loading</h5>
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              <h5 className="font-semibold text-neutral-800">Separators</h5>
              <div className="space-y-4">
                <div>
            ...
            <div className="space-y-3">
              <h5 className="font-semibold text-neutral-800">Calendar</h5>
